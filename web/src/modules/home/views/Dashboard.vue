    ...
    <BaseCard showHeader="true">
      ...
      <v-card>
        <v-row>
          ...
          <v-col>
            <add-room-btn v-if="activeTab == tabs['rooms'] && isAdmin"></add-room-btn>
            <add-asset-btn v-if="activeTab == tabs['assets'] && isAdmin"></add-asset-btn>
            <add-key-btn v-if="activeTab == tabs['keys'] && isAdmin"></add-key-btn>
          </v-col>
        </v-row>
